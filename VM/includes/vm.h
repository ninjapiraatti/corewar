...
void					manage_aff(t_carriage *carr, t_arena *a, t_flag *flags);
...
int						check_inst(int inst, unsigned char arg_code,
						t_carriage *c, t_arena *a);
int						check_(int inst, unsigned char arg_code,
						t_carriage *c, t_arena *a);
...
void					ncurses_declare_winner(int number, char *winner_name);
